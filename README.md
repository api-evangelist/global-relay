...
**URL:** [Visit APIs.json URL](https://raw.githubusercontent.com/api-evangelist/global-relay/refs/heads/main/apis.yml)
...
## Tags:
 ...
 - Compliance, Archiving, Email Security, Data Retention, Regulatory Compliance
...
#### Tags:
 ...
 - Compliance, Archiving, Messaging

#### Properties

- [Documentation](https://developers.globalrelay.com/api/conversation-archiving-api/)
- [OpenAPI](openapi/global-relay-conversation-archiving-api-openapi.yml)
...
#### Tags:
 ...
 - Compliance, Archiving, Email

#### Properties

- [Documentation](https://developers.globalrelay.com/api/email-archiving-api/)
- [OpenAPI](openapi/global-relay-email-archiving-api-openapi.yml)
...
#### Tags:
 ...
 - Compliance, Archiving, Voice

#### Properties

- [Documentation](https://developers.globalrelay.com/api/voice-archiving-api/)
- [OpenAPI](openapi/global-relay-voice-archiving-api-openapi.yml)
...
#### Tags:
 ...
 - Compliance, Archiving, Social Media, Collaboration

#### Properties

- [Documentation](https://developers.globalrelay.com/api/event-archiving-api/)
- [OpenAPI](openapi/global-relay-event-archiving-api-openapi.yml)
